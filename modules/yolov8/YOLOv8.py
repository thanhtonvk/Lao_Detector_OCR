...
from modules.yolov8.utils import xywh2xyxy, multiclass_nms
...
class YOLOv8:
    ...
    def initialize_model(self, path):
        provider = 'CPUExecutionProvider' if config.DEVICE == "cpu" else 'ROCMExecutionProvider'
        # self.session = onnxruntime.InferenceSession(path, providers=[provider])
        self.session = onnx_model_inference(path)
